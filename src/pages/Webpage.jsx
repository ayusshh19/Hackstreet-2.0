...
import { getchatitle, sendchat, weblinkhandle } from "../action/Chataction";
...
function Webpage(props) {
  ...
  useEffect(() => {
    dispatch({ type: NEW_CHAT_ID, payload: 3 });
  }, []);
  const handlesubmit = () => {
        ...
        <div className="flex flex-col w-full h-full justify-center items-center gap-10 mt-12 sm:mt-0">
          <div>
            <h1 className="text-6xl my-4 text-center ">
              UrGPT
              <span className=" border-l-2 p-1 border-innercol ml-5  bg-gradient-to-r from-fillcomp to-darkbg">
                Web
              </span>
            </h1>
