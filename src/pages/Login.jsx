        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <div className="mt-8">
            {loading ? (
              ...
              <button
                className="bg-fillcomp text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-600"
                onClick={loginSubmit}
              >
                Login
              </button>
          ...
          <div className="w-full h-full flex flex-col items-center my-4">
            ...
            <div className="text-center h-1/3">
              ...
              <h4 className="text-sm">
                New pdf question answering system with integretion<br></br> with
                Ai kindly use and provide feedback
              </h4>
            </div>
          </div>
        </div>
